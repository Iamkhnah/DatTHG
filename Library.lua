--// open source - I just mod this Ui Lib. NOT MY OWN
local UILibrary = {}
--// Modules
...
local function getObjGen()
	...
	local function getObjects()
		local function initObj()
			...
			Gui.Logo.Size = UDim2.new(0.6, 0,0.12, 0)
			Gui.Logo.ZIndex = 122
			Gui.Logo.Image = "rbxassetid://104604638602603"
			Gui.Logo.ScaleType = Enum.ScaleType.Tile
			local ggmrbeast = Instance.new("UICorner")
			ggmrbeast.Parent = Gui.Logo
			local givay = Instance.new("UIStroke")
			givay.Color = Color3.new(48, 48, 67)
...
function UILibrary.new(gameName, userId, rank)
	...
	--uicor.CornerRadius = UDim.new(0.1)
	--uicor.Parent = Frame
	local uistroke = Instance.new("UIStroke")
	uistroke.Parent = window.MainUI
	uistroke.Color = Color3.new(0.772549, 0.717647, 1)
	
	
	local Drag = Draggable.Drag(window.MainUI, Frame)
	
	--// Customize the GUI
	window.Watermark.Text = "DatTHG script - Code By: P.Khanh"
...
function UILibrary.UiToggle()
	if _G.MainUi then
		_G.MainUi.Enabled = not _G.MainUi.Enabled
	end
end
...
function UILibrary.Button:Section(name, side)
	...
	Section.Name = name
	Section.Border.SectionTitle.TextColor3 = Color3.new(0.72549, 0.729412, 1)
